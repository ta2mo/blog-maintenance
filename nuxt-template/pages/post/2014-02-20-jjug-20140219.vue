          ...
          <nav class="level">
            <div class="level-left is-left">
              <div class="level-item">
                ...
                <nuxt-link class="is-right is-pulled-left" to="/post/2014-03-17-jaws-days-2014">
                  <p class="heading">←Newer</p>
                  <span>JAWS DAYS 2014に参加してみたメモ</span>
                </nuxt-link>
            ...
            <div class="level-right is-right">
              <div class="level-item">
                ...
                <nuxt-link class="is-left" to="/post/2014-02-17-scala-play-setup-memo">
                  <p class="heading">Older→</p>
                  <span>ScalaとPlayFrameworkの設定メモ</span>
                </nuxt-link>
